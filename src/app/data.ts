...
const getDemoAudioUrl = (n: number) =>
  `https://www.soundhelix.com/examples/mp3/SoundHelix-Song-${n}.mp3`;

// ── Episodes ───────────────────────────────────────────────────────────────────
export const episodes: Episode[] = [
  { id: 1,  title: "The Future of Innovation",         description: "Exploring groundbreaking ideas and the minds behind them. Join us as we dive deep into what's next.",               audioUrl: getDemoAudioUrl(1),  duration: "45 min", date: "Mar 8, 2026",  episodeNumber: 12, coverColor: "#B42970",  imageUrl: IMG_PODCAST_FUN },
  { id: 2,  title: "Building Sustainable Communities", description: "Creating lasting impact in local and global communities through innovative approaches and collective action.",        audioUrl: getDemoAudioUrl(2),  duration: "38 min", date: "Mar 1, 2026",  episodeNumber: 11, coverColor: "#72c472",  imageUrl: IMG_DIVERSE    },
  { id: 3,  title: "Technology Meets Humanity",        description: "The intersection of technology and human experience, and how we can build better futures together.",                  audioUrl: getDemoAudioUrl(3),  duration: "52 min", date: "Feb 22, 2026", episodeNumber: 10, coverColor: "#5f9de3",   imageUrl: IMG_STUDIO_MIC },
  { id: 4,  title: "Creative Collaboration",           description: "How diverse teams create extraordinary outcomes. Stories from the frontlines of innovation.",                         audioUrl: getDemoAudioUrl(4),  duration: "41 min", date: "Feb 15, 2026", episodeNumber: 9,  coverColor: "#e8563a", imageUrl: IMG_AUDIO_EQ   },
  { id: 5,  title: "Reimagining Education",            description: "The future of learning and how we're preparing the next generation for challenges we can't yet imagine.",             audioUrl: getDemoAudioUrl(5),  duration: "47 min", date: "Feb 8, 2026",  episodeNumber: 8,  coverColor: "#f4a0b4",   imageUrl: IMG_DESK_SETUP },
  { id: 6,  title: "Climate Action Stories",           description: "Real people making real change in the fight against climate change — and the tech tools driving it.",                audioUrl: getDemoAudioUrl(6),  duration: "44 min", date: "Feb 1, 2026",  episodeNumber: 7,  coverColor: "#72c472",  imageUrl: IMG_STUDIO_MIC },
  { id: 7,  title: "Women Who Code the World",         description: "Celebrating the engineers, developers, and architects shaping the software that runs our everyday lives.",           audioUrl: getDemoAudioUrl(7),  duration: "50 min", date: "Jan 25, 2026", episodeNumber: 6,  coverColor: "#B42970",  imageUrl: IMG_DIVERSE    },
  { id: 8,  title: "Designing for Inclusion",          description: "Why accessible design is good design — and how building for everyone unlocks better products for all.",               audioUrl: getDemoAudioUrl(8),  duration: "36 min", date: "Jan 18, 2026", episodeNumber: 5,  coverColor: "#5f9de3",   imageUrl: IMG_AUDIO_EQ   },
  { id: 9,  title: "The Startup Journey",              description: "From idea to launch: the raw, unfiltered stories of women who took the leap and built something from nothing.",      audioUrl: getDemoAudioUrl(9),  duration: "55 min", date: "Jan 11, 2026", episodeNumber: 4,  coverColor: "#e8563a", imageUrl: IMG_PODCAST_FUN },
  { id: 10, title: "AI & the Human Touch",             description: "Navigating artificial intelligence with empathy, ethics, and a distinctly human perspective.",                       audioUrl: getDemoAudioUrl(10), duration: "48 min", date: "Jan 4, 2026",  episodeNumber: 3,  coverColor: "#f4a0b4",   imageUrl: IMG_DESK_SETUP },
  { id: 11, title: "Leading Without a Playbook",       description: "Women in leadership share what it really takes to lead teams, set culture, and make hard calls in uncertain times.", audioUrl: getDemoAudioUrl(11), duration: "43 min", date: "Dec 28, 2025", episodeNumber: 2,  coverColor: "#72c472",  imageUrl: IMG_STUDIO_MIC },
  { id: 12, title: "Why She Started",                  description: "Our very first episode — the origin story of Unlock Her Tech and the 'why' behind every conversation we have.",     audioUrl: getDemoAudioUrl(12), duration: "32 min", date: "Dec 21, 2025", episodeNumber: 1,  coverColor: "#B42970",  imageUrl: IMG_DIVERSE    },
];
