...
export const teamMembers = [
    ...
    { name: "Martina Rondinelli",   role: "Graphic & UX/UI Designer",                 bio: "Martina is the creative force shaping how Unlock Her Tech looks and feels across every touchpoint. From brand visuals and episode artwork to intuitive digital experiences, she blends bold aesthetics with thoughtful design thinking — ensuring the show's visual identity is as compelling as its conversations.", avatarColor: ORANGE, photoUrl: "https://ui-avatars.com/api/?name=Martina+Rondinelli&background=e8563a&color=fff&size=400&bold=true&rounded=true" },
];