        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-gray-900 mb-6 leading-tight">
              From a Storytelling Microphone to a <span className="text-brand-coral">Hands-On Technical Community</span>
            </h2>
            <div className="space-y-4 text-gray-600 text-base sm:text-lg leading-relaxed">
              <p>
                Unlock Her Tech began with a microphone and a clear conviction: to dismantle the isolation often felt by women and non-binary people in technology through authentic, unfiltered conversations.
              </p>
              <p>
              ...
              <p className="text-gray-900 font-semibold">
                Today, we operate on dual pillars: inspiring podcast dialogues with tech trailblazers, paired with fortnightly <strong className="text-brand-coral">She Leads Tech Practices</strong>.
              </p>
            </div>
